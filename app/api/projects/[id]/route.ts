...
//     // 3. fetch the full project with related data
//     const project = await prisma.project.findUnique({
//       where: { id },
//       include: {
//         columns: {
...
//     // 3. only owners and admins can update projects
...
//     // 4. parse the request body and build the update data
...
//     // 3. only owners and admins can delete projects
//     if (access.membership.role !== "OWNER" && access.membership.role !== "ADMIN") {
//       return NextResponse.json(
...
//     // 4. delete everything in a transaction (no cascade deletes in schema)
