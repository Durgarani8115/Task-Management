...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var formData, email, password, user, isValid, token, response;
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    formData = _c.sent();
                    email = (_a = formData.get("email")) === null || _a === void 0 ? void 0 : _a.toString().trim().toLowerCase();
                    password = (_b = formData.get("password")) === null || _b === void 0 ? void 0 : _b.toString();
                    if (!email || !password) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: "Email and password are required" }, { status: 400 })];
                    }
                ...
                case 2:
                    ...
                    isValid = (0, auth_1.verifyPassword)(password, user.passwordHash);
                    if (!isValid) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: "Invalid credentials" }, { status: 401 })];
                    }
